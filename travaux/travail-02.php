...
echo '<h3>' . $json_array_php[2]['friends'][1]['name'] . '</h3>';
echo '<hr>';
echo 'Les yeux de Ball Shaffer sont de couleur : <strong>' . $json_array_php[1]['eyeColor'] . '</strong>';
echo '<hr>';

echo '<article>';
foreach($json_array_php as $key => $value){
		$tagTab = [];
